...
| 1/28 | Transformer II | DNA language models | [MAMBA](https://arxiv.org/abs/2312.00752); [Evo](https://www.science.org/doi/10.1126/science.ado9336)
| 1/30 | Equivariant neural networks I | Molecular property prediction |
| 2/4  | Equivariant neural networks II | Protein structure modeling |
| 2/6  | Diffusion models I (Gaussian diffusion) | Image generation |
| 2/11 | Diffusion models II (Flow matching) | Protein folding | 
| 2/13 | Diffusion models III (Discrete diffusion) | Protein design |
| 2/18 | Reinforcement learning I (PPO) | De novo drug design | 
| 2/20 | Reinforcement learning II (Monte Carlo tree search) | Chemical retrosynthesis |
| 2/25 | Foundation models I (Self-supervised learning) | Biomedical image analysis |
| 2/27 | Foundation models II (LLM and agents) | Miscellaneous |
| 3/4-3/6  | Spring break (no class) |
| 3/11 | Research frontier I |
